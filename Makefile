...
$(wildcard Firmware/GD32F3x0_usbfs_driver/Source/system_*.c) \
$(wildcard Firmware/GD32F3x0_usbfs_driver/Source/usb_*.c) \
...
ifeq ($(USB_DEVICE), 1)
C_SOURCES += $(wildcard Firmware/GD32F3x0_usbfs_driver/Source/usbd_*.c)
endif
ifeq ($(USB_HOST), 1)
$(wildcard Firmware/GD32F3x0_usbfs_driver/Source/usbh_*.c)
endif
...
-IFirmware/GD32F3x0_usbfs_driver/Include \
-IUtilities	\
